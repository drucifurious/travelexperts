      ...
      <div class="wrapper-main">
        <section class="section-default">
          ...
          <form class="form-signup" action="includes/signup.inc.php" method="post">
            ...
            // We check username.
            if (!empty($_GET["uid"])) {
              echo '<input class="drew" type="text" name="uid" placeholder="Username" value="'.$_GET["uid"].'">';
            }
            else {
              echo '<input class="drew" type="text" name="uid" placeholder="Username">';
            }

            // We check e-mail.
            if (!empty($_GET["mail"])) {
              echo '<input id="down" class="drew" type="text" name="mail" placeholder="E-mail" value="'.$_GET["mail"].'">';
            }
            else {
              echo '<input class="drew" type="text" name="mail" placeholder="E-mail">';
            }
            ?>
            <input class="drew" type="password" name="pwd" placeholder="Password">
            <input class="drew" type="password" name="pwd-repeat" placeholder="Repeat password">
            <button class="myButton" type="submit" name="signup-submit">Signup</button>
          </form>
          <!--
